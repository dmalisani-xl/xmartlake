...
@patch("app.game.save_doc")
def test_player_load_bullets_with_shield(patched_save_doc, monkeypatch: MonkeyPatch):
    patch_settings(monkeypatch)
    player = PLAYER_1.copy()
