...
class TurnCallerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.play = channel.unary_unary(
                '/TurnCaller/play',
                request_serializer=bots__pb2.TurnMessage.SerializeToString,
                response_deserializer=bots__pb2.PlayerResponse.FromString,
                )
...
def add_TurnCallerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'play': grpc.unary_unary_rpc_method_handler(
                    servicer.play,
                    request_deserializer=bots__pb2.TurnMessage.FromString,
                    response_serializer=bots__pb2.PlayerResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class TurnCaller(object):
    ...
    def play(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/TurnCaller/play',
            bots__pb2.TurnMessage.SerializeToString,
            bots__pb2.PlayerResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
